INSERT INTO formulas (nombre, formula, detalle, indice, tema_id, created_at, updated_at) VALUES
...
INSERT INTO formulas (nombre, formula, detalle, indice, tema_id, created_at, updated_at) VALUES
('resta o diferencia de sus raices', '$$x_1 - x_2 = \\sqrt{\\frac{b^2 - 4ac}{a^2}}$$', '<p>Resta de las raíces: La resta de las raíces de la ecuación cuadrática es $$\\sqrt{\\frac{b^2 - 4ac}{a^2}}$$. Es decir, si las raíces son $$x_1$$ y $$x_2$$, entonces $$x_1 - x_2 = \\sqrt{\\frac{b^2 - 4ac}{a^2}}$$.</p><p>Espero que esto te sea útil. Si tienes alguna pregunta más, no dudes en visitar <a href=\"https://formula.ife.bo/\">formula.ife.bo</a>.</p>', 0, 3, '2023-04-04 16:23:01', '2023-04-04 16:26:02');
INSERT INTO formulas (nombre, formula, detalle, indice, tema_id, created_at, updated_at) VALUES
