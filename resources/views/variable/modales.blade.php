                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formulario-editar-variable">
                            ...
                            <input class="form-control" type="number" hidden id="variable_id" value="">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card card-primary">
                    <div class="card-header bg-secondary">
                        <span class="card-title">Crear Variable</span>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                            <div class="alert alert-danger">
                        ...
                        <form id="formulario-crear-variable">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                                    <div class="form-floating mb-3 text-gray">
                                        <select class="form-control @error('id_dimension') is-invalid @enderror" data-old="{{ old('id_dimension') }}" name="id_dimension" id="id_dimension">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                                        <div class="form-floating mb-3 text-gray">
                                            @error('id_dimension') <span class="text-danger">{{$message}}</span> @enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid h-100 mt-3"> 
                                <div class="row w-100 align-items-center">
                                    <div class="col text-center">
                                        <button id="guardar-variable" class="btn btn-primary text-white btn-lg">Actualizar <i class="fas fa-sync"></i></button>        
                                    </div>	
                                </div>
                            </div>
                        </form>
